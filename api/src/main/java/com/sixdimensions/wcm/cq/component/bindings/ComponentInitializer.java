...
/**
 * A component initializer for every script load (including scripts in languages
 * besides JSP). This service should then initialize any variables needed for
 * the component and perform any needed processing.
 * 
 * In JSPs the variables will be available in the context variable 'bindings', eg:
 * <code>${bindings.var}</code>
 * 
 * @author dklco
 */
